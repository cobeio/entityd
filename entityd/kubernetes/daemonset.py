...
class DaemonSetEntity(entityd.kubernetes.BasePlugin):
    ...
    def __init__(self):
        super().__init__()
        self.entity_name = 'Kubernetes:DaemonSet'
        self.plugin_name = 'entityd.kubernetes.daemonset.DaemonSetEntity'
    ...
    def create_entity(self, resource, pods):
        ...
        attributes = {
            'kubernetes:current-number-scheduleds': 'current_number_scheduled',
